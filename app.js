...
function App(){
  ...
  if(maintenance===null) return CE('div',{style:{display:'flex',alignItems:'center',justifyContent:'center',minHeight:'100vh',background:'var(--bg)'}},CE(AttenteGAS,{titre:'Ateliers Inclusion Numérique'}));
